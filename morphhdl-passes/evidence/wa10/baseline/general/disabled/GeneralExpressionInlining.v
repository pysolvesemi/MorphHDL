module GeneralExpressionInlining #(
  ...
  wire       [17:0]   _zz_muxResult_1;
  wire       [17:0]   _zz_state;
  wire       [17:0]   _zz_state_1;
  wire       [17:0]   _zz_state_2;
  ...
  assign _zz_extensionSum = {2'd0, other};
  ...
  assign _zz_muxResult = {2'd0, word};
  assign _zz_muxResult_1 = {2'd0, other};
  assign _zz_state = (_zz_state_1 + _zz_state_2);
  assign _zz_state_1 = {2'd0, word};
  assign _zz_state_2 = {2'd0, other};
  ...
  assign extensionSum = (_zz_extensionOK + _zz_extensionSum);
  ...
  assign muxResult = ((choose ? _zz_muxResult : _zz_muxResult_1) + 18'h00001);
