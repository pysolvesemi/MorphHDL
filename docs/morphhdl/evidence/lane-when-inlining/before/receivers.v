module LaneReceiverCoverageExample #(
  ...
  wire       [15:0]   _zz_lanes_2;
  wire       [15:0]   _zz_lanes_3;
  ...
  wire       [15:0]   _zz_lanes_4;
  wire       [15:0]   _zz_lanes_5;
  ...
  wire       [15:0]   _zz_lanes_6;
  wire       [15:0]   _zz_lanes_7;
  ...
  assign _zz_lanes = {3'd0, io_x};
  assign _zz_lanes_1 = {4'd0, io_y};
  ...
  assign _zz_lanes_2 = {3'd0, io_x};
  assign _zz_lanes_3 = {4'd0, io_y};
  ...
  assign _zz_lanes_4 = {3'd0, io_x};
  assign _zz_lanes_5 = {4'd0, io_y};
  ...
  assign _zz_lanes_6 = {3'd0, io_x};
  assign _zz_lanes_7 = {4'd0, io_y};
  ...
  always @(*) begin
    lanes[0] = (io_mask[0] && ((io_running && (_zz_lanes < io_hActive)) && (_zz_lanes_1 < io_vActive)));
    lanes[1] = (io_mask[1] && ((io_running && (_zz_lanes_2 < io_hActive)) && (_zz_lanes_3 < io_vActive)));
    lanes[2] = (io_mask[2] && ((io_running && (_zz_lanes_4 < io_hActive)) && (_zz_lanes_5 < io_vActive)));
    lanes[3] = (io_mask[3] && ((io_running && (_zz_lanes_6 < io_hActive)) && (_zz_lanes_7 < io_vActive)));
  end
