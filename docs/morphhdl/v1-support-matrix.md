...
| RTL | Registers and sync/async reset | v1 | Increments 16 and 17 implement positive-edge atomic registers with active-high synchronous and asynchronous reset-to-zero; clock enables and broader state remain bounded follow-on work |
