...
| RTL | Registers and sync/async reset | v1 | Increments 16 and 17 implement active-high synchronous/asynchronous reset-to-zero; Increment 18 adds reset-priority active-high synchronous enable with disabled hold; asynchronous enable and broader state remain bounded follow-on work |
