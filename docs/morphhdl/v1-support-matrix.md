...
| Parameters | Derived local parameters | v1 | Increments 8 and 13 capture identity-bearing integer and Boolean locals in one deterministic dependency graph |
...
| Structure | Generate-if/case | v1 | Increment 9 implements one mandatory two-branch, non-nested generate-if; Increments 12 and 13 add bound Boolean parameters and derived Boolean locals as conditions; case remains planned |
