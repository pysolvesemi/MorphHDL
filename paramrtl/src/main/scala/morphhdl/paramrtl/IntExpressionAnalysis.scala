...
private[morphhdl] object IntExpressionAnalysis {
  ...
  def analyze(
    ...
    case Negate(value) =>
      analyze(value, parameters, localParameters, booleanParameters, booleanLocalParameters, generateIndices).map { facts =>
        IntExprFacts(
          -facts.defaultValue,
    ...
    case Add(left, right) =>
      analyzeBinary(left, right, parameters, localParameters, booleanParameters, booleanLocalParameters, generateIndices) {
    ...
    case Select(condition, whenTrue, whenFalse) =>
      ...
      val trueResult =
        analyze(whenTrue, parameters, localParameters, booleanParameters, booleanLocalParameters, generateIndices)
      val falseResult =
        analyze(whenFalse, parameters, localParameters, booleanParameters, booleanLocalParameters, generateIndices)
  ...
  private def analyzeBinary(
    ...
    analyze(left, parameters, localParameters, booleanParameters, booleanLocalParameters, generateIndices).flatMap { leftFacts =>
      analyze(right, parameters, localParameters, booleanParameters, booleanLocalParameters, generateIndices).map { rightFacts =>
  ...
  private def analyzeDivisionLike(
    ...
    analyze(left, parameters, localParameters, booleanParameters, booleanLocalParameters, generateIndices).flatMap { leftFacts =>
      analyze(right, parameters, localParameters, booleanParameters, booleanLocalParameters, generateIndices).flatMap { rightFacts =>
