#!/usr/bin/env python3
"""Prepare the reviewed schema-5 PR190 integration manifest for one exact committed source.
...
EXPECTED_HELPER = "b6d8b5183402b15e5b6c0c0ebc1bc79f54e3a822a913c2f92453cdf050759377"
EXPECTED_PARENT = "58fb59773a2deebba0251b5b626c19a22453f0a4"
EXPECTED_PARENT_SOURCE = "545134a42dd200c5cee679db5dde0fea0acb15c9"
EXPECTED_PARENT_MANIFEST = "846260ee4f99965c38224fe32a426a5ac474c67cb561f499b8097fbe3c8a9863"
    ...
    for path in sorted(paths):
        ...
        if old is not None and all(old[key] == value for key, value in exact_identity.items()):
            ...
            entry = dict(exact_identity,
                reason=(old["reason"] + " " if old else "") + "PR190 integration continuation: " + rationale,
...
def prepare(root, source, reasons_path):
    ...
    require(previous_target["target_commit"] == common and target_commit == helper.PR190_TARGET,
        "previous target is not the exact new integration common base")
    ...
    # These run the original frozen 58fb predecessor chain and original PR190 target
