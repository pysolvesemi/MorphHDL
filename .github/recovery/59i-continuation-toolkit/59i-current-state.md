...
## Active targeted run and hourly continuation
Recovery controller0a617e36f0e4c1265eb52a3ef59a4b0f7bc98a2d, treef14497ef1e6df97f13a854cc90ed81ce9b90732e, parent0d25fd30;63reviewed files published including inactive full diagnostic and continuation toolkit. Exactly one active workflow changed. Targeted run35443564906 was allocated and observed in_progress. No full v5 diagnostic, source seal, feature push, fullCI or merge occurred.
Hourly automation `Continue59iCI` enabled successfully, ID6aae834192c8819195f25e56cdc525f7, scheduleFREQ=HOURLY;INTERVAL=1, created2026-09-19T12:42:42Z. Its prompt contains exact current run/source/controller plus durable recovery paths and authorized failed-first-through-merge continuation. Stop minute polling; inspect on hourly iterations or when user explicitly requests. PR remains draft90b, targete0e9.

## User-reported 86f6 diagnostic failure and active repair

Run35443564906 failed at priority COUNT5/candidate0/unsigned0. The 657-cell bit-normalized query still timed out at120seconds (231797variables618922clauses). Main was intentionally skipped; supplemental and original124RTL unchanged passed. Artifact10584219929 SHA25616d0621df859ee0855fed99450fa424fad8ae08d5dd27468251b131e5775610e was independently inspected:713files complete, exact86f6source/tree, receipt evidence/86f6-checker-failed-verification.json. This is not a main-checker pass.

Active repair is adding actual-netlist register correspondence as extra equality proof obligations, never initial assumptions or register rewrites. Original COUNT5 normalized graph has71native/candidate independent register-bit pairs. Finite incremental base checks must prove every step2..18 following enabled native resetstep1. Pin exactYosys0.41 semantics; retain alloriginal case/bit/mutation coverage and unconstrained later inputs. Source remains unsealed and no new run is launched until independent review and concrete controller/verifier preparation finish. Existing hourly automation temporarily coordinates against simultaneous repair; root will remove that coordination prefix when updating it to the replacement run.

## Reviewed finite-state proof source

Clean unsealed source545134a42dd200c5cee679db5dde0fea0acb15c9, treecab84063b2933dd146f2b5ff37aab42f7ea0b191, soleparent86f6e3d9. Exactlyonefilechanged (mainchecker;201insertions19deletions). CheckerSHA256e522d80a10040cc59e9c484e56573b15b85ff8d4041b4fe62d4720cf0b6f3a40. Independent finalreview:59i-finite-state-proof-soundness-review.md; actualretained structuralreview:evidence/59i-finite-state-independent-structural-review.json (earliercheckerhashbeforeparser-onlyhardening explicitlyrecorded). All657originalcells preserved,71statepairs,142addedpropertygates, freshIDs899..1040aboveeveryoriginalnetname. Introducedinit, brokenstatepair/clock, missing/duplicate/earlyterminal/skipped/timeoutprooflogs rejected. Localconstruction andparserchecksarenotHDLexecution.

Positive proofs now use Yosys0.41 -seq1 -tempinduct-baseonly -maxsteps17, fixedenabledresetstep1, allfreeinputsafterward. This proves propertyatsteps2..18 through17orderedbasecases; -prove-skipmustbeabsent becausemodeincompatible. Reuseisonlyofpreviouslyprovedproperties; repeatedcompletestatepruningissoundbyloopremovalwithstationarypropertyandfreepostresetinputs. No unboundedinductionclaim, FFmerging, rewrittenDUT, cutpoints orinitialequalities. OriginaloutputbitisconjoinedwitheveryreachablepairedQequalityasadditionalproofgoals. Maincount/candidate/bitcoverage, simulation, stricttools, normalizedbaseline andactualmutationsareunchanged.

Fresh full diagnosticv6preparedinactive incontroller-development-v6/:11preservedunpublishedcommits,33paths,115107bytebundleSHAa8058b0fd1c0c13840db01c3bc9a938a4d8ae1ae838248cb03d90da248d36fdc;compressedSHA32ae779c769206765cd50c3678261e2fe684acca9d736a91ab90703ba34557b4. Do not run beforeverifiednarrowpass. Newnarrowcontroller/verifiersv3arebeingpreparedfortheexact545134a4source. No sealstaged, featurepush, fullCI, TODO ormerge.
