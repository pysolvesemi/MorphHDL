...
m.PLAN_SHA256 = '4b8c1e01e0507ac7ecaf0f7f7c3547e8fd7a6b6fc7f92bdb9473ac4f3be18ef5'
...
m.CONTROLLER = 'increment-59i-targeted-schema17.yml'
m.WORKFLOW_HASHES = {
...
m.HISTORICAL = (
    ...
    ('increment-59f-callback-graphs.yml', 35932294818, 'failure'),
)
...
m.b.prior_failures = m.prior_failures
