#!/usr/bin/env python3
"""One-shot PR191 golden-repair follow-up for three diagnosed workflows."""
import argparse
import hashlib
...
HEAD = base.HEAD
ALLOWED_IDS = {332279971, 351327055, 357516223}
base.ALLOWED_IDS = ALLOWED_IDS
require = base.require
write_journal = base.write_journal
Api = base.Api
refs_guard = base.refs_guard
choose_existing = base.choose_existing
authenticate_failures = base.authenticate_failures
