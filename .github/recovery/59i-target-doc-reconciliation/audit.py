#!/usr/bin/env python3
"""Authenticate the final schema-15 source evidence and current target."""
...
SEAL = "c48bad51b9857570e65fbd7c1be5dec465a3e8fa"
SEAL_TREE = "6c2bee9158e61022a4fdc56efb33b056bf2135ff"
SOURCE = "9270cb332aba63b6ea7ca17dc2694b93ff7ded52"
SOURCE_TREE = "898934c355f6a7280932f92e5e7f88f2e1f3bc1b"
PREDECESSOR_SEAL = "5adb952e038cd001f9a4adb27292a9fd7614fbe8"
PREDECESSOR_SEAL_TREE = "23e84f75a05372bfd0f819355806bd71dbcc31a5"
PREDECESSOR_SOURCE = "5a8178aa2422fb1987d7bab8692a107599c9b7ef"
PREDECESSOR_SOURCE_TREE = "ec400eb14314a82fdb924f1824bb62a43cb0532b"
ANCESTOR_SEAL = "d6536e454b69346fe0954a322e0515396812f218"
ANCESTOR_SEAL_TREE = "17b93cad066276a2ab96a3325ed0e02d85e7e6f5"
ANCESTOR_SOURCE = "f6575ae3559aa65a042bd644a93068a4a2044fbf"
ANCESTOR_SOURCE_TREE = "68a31a90d404c4ac693dccbb8d1c565adfca9af1"
PRIOR_SEAL = "c654f43c24d86ca99c056dd4cb74b7a18d9f41e3"
PRIOR_SEAL_TREE = "815a381426e9507363ab91bd3a258ab9668fb87a"
PRIOR_SOURCE = "2797acc2fbeb0733c29d8c05d64857801de32ae2"
PRIOR_SOURCE_TREE = "bad8f069942e54c0e4736076ebe5ff336dec26d6"
OLDER_SEAL = "1eb63e57d41fb1f707da8ca7f176b1ecc609aebf"
OLDER_SEAL_TREE = "e22a4775ab70c3c1d516ba2d83323f2273776c63"
OLDER_SOURCE = "1ee1e5e3e84497de4b983e08be31e46ceb4dbc25"
OLDER_SOURCE_TREE = "324087367b0b979bf8eee675d96c74f40937e2ac"
...
FEATURE = "c654f43c24d86ca99c056dd4cb74b7a18d9f41e3"
FEATURE_TREE = "815a381426e9507363ab91bd3a258ab9668fb87a"
...
ARTIFACT_SHA256 = "57be92bb60064434df805f39718aedfc52224a8056aff3b95940dcfa4612b5a5"
CONTRACT_SHA256 = "a7d4a932e189a56eeb16483c43df7e1fe916a84e47da9f8f7aa2e64db71e5572"
HELPER_NORMALIZED_SHA256 = "70009882bc3fde5ec691a68945fdb3a63d707c4f4f9c67a3f6ccbf1650ccea4a"
...
def require(ok: bool, detail: str) -> None:
    if not ok:
        raise RuntimeError("59i schema-15 target reconciliation: " + detail)
...
def validate(repo: Path, artifact: bytes) -> dict:
    ...
    chains = ((SEAL, [SEAL, SOURCE]),
              ...
              (OLDER_SOURCE, [OLDER_SOURCE, DOCUMENTATION_CHECKPOINT]),
    ...
    require(identity == [SEAL, SOURCE, PREDECESSOR_SEAL, PREDECESSOR_SOURCE,
        ...
        OLDER_SOURCE, DOCUMENTATION_CHECKPOINT, EARLIER_SEAL, FEATURE, SEAL_TREE,
    ...
    return {"schema": 15, "source_run": 35896802730, "source_artifact": 10778797876,
...
def main() -> None:
    ...
    print("INCREMENT_59I_SCHEMA15_TARGET_RECONCILIATION_PASS", flush=True)
