module LaneConditionCoverageExample #(
  ...
  wire                when_LaneConditionCoverageExample_l34;
  wire                when_LaneConditionCoverageExample_l41;
  wire                when_LaneConditionCoverageExample_l46;
  wire                when_LaneConditionCoverageExample_l49;
  wire                when_LaneConditionCoverageExample_l53;
  wire                when_LaneConditionCoverageExample_l55;
  wire                when_LaneConditionCoverageExample_l65;
  ...
  always @(*) begin
    ...
    if(when_LaneConditionCoverageExample_l34) begin
      io_singleX = 13'h0;
    end
  end

  assign when_LaneConditionCoverageExample_l34 = (io_x == (io_hTotal - 13'h0001));
  assign when_LaneConditionCoverageExample_l41 = (io_x == (io_hTotal - 13'h0001));
  always @(*) begin
    io_sharedX = (io_x + 13'h0001);
    if(when_LaneConditionCoverageExample_l41) begin
      io_sharedX = 13'h0;
    end
  end
  ...
  always @(*) begin
    ...
    if(when_LaneConditionCoverageExample_l46) begin
      io_nestedX = 13'h0;
    end
  end
  ...
  always @(*) begin
    ...
    if(when_LaneConditionCoverageExample_l46) begin
      ...
      if(when_LaneConditionCoverageExample_l49) begin
        io_nestedY = 12'h0;
      end
    end
  end

  assign when_LaneConditionCoverageExample_l46 = (io_x == (io_hTotal - 13'h0001));
  assign when_LaneConditionCoverageExample_l49 = (io_y == (io_vTotal - 12'h001));
  assign when_LaneConditionCoverageExample_l53 = (io_x == 13'h0);
  always @(*) begin
    if(when_LaneConditionCoverageExample_l53) begin
      io_priority = 2'b00;
    end else begin
      if(when_LaneConditionCoverageExample_l55) begin
        io_priority = 2'b01;
      end else begin
        io_priority = 2'b10;
      end
  ...
  assign when_LaneConditionCoverageExample_l55 = (io_x == (io_hTotal - 13'h0001));
  assign when_LaneConditionCoverageExample_l65 = (io_y == (io_vTotal - 12'h001));
  assign io_booleanRhs = when_LaneConditionCoverageExample_l65;
  always @(*) begin
    io_mixedX = io_x;
    if(when_LaneConditionCoverageExample_l65) begin
      io_mixedX = 13'h0;
    end
  end
