...
- `lane_array.v` is the next expected-output contract. Hierarchy is now
  implemented independently; this fixture retains the pending named
  generate-for loop and parameterized indexed part-select work.
- The generated-fixture testbenches cover default, minimum, awkward and mixed
  ...
  instances of one emitted hierarchy.
...
The lane-array fixture remains an expected-output contract until a later
increment implements generate support.
