module SynchronousRegisterTb;
  ...
  SynchronousRegister default_width (
    .clk(clk),
  ...
  initial begin
    ...
    if (data_out_default !== 8'ha5 || data_out_width_five !== 5'h13) begin
      $display("FAIL: SynchronousRegister initial capture");
      $finish;
    end
    ...
    #1;
    if (data_out_default !== 8'ha5 || data_out_width_five !== 5'h13) begin
      $display("FAIL: SynchronousRegister reset changed output away from posedge");
      $finish;
    end
    ...
    if (data_out_default !== 8'h00 || data_out_width_five !== 5'h00) begin
      $display("FAIL: SynchronousRegister synchronous reset");
      $finish;
    end
    ...
    #1;
    if (data_out_default !== 8'h00 || data_out_width_five !== 5'h00) begin
      $display("FAIL: SynchronousRegister data changed output away from posedge");
      $finish;
    end
    ...
    if (data_out_default !== 8'h7e || data_out_width_five !== 5'h1d) begin
      $display("FAIL: SynchronousRegister post-reset capture");
      $finish;
    end

    $display("PASS: SynchronousRegister");
    $finish;
  end
endmodule
