module BooleanLocalRoutingTb;
  ...
  BooleanLocalRouting default_dut (
  ...
  initial begin
    ...
    if ((default_dout !== default_high_in) ||
        ...
        (default_dut.g_local_high.route_inst.g_high.selected_inst.high_out !== default_dout) ||
        (disabled_dut.g_local_low.route_inst.g_low.selected_inst.low_out !== disabled_dout) ||
        (below_dut.g_local_low.route_inst.g_low.selected_inst.low_out !== below_dout) ||
        (equal_dut.g_local_high.route_inst.g_high.selected_inst.high_out !== equal_dout)) begin
      $display("FAIL: BooleanLocalRouting");
    end else begin
      $display("PASS: BooleanLocalRouting");
    end
