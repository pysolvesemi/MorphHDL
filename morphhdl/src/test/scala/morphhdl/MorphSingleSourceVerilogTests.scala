...
class MorphSingleSourceVerilogTests extends AnyFunSuite {
  ...
  // Exact symbolic_data_shapes.v bytes from 0a512546a38ed82b916f975025f5da278a68a6aa.
  // Do not derive this legacy oracle by rewriting the enabled DUT or golden.
  private def expectedDisabledSymbolicDataShapes: String =
