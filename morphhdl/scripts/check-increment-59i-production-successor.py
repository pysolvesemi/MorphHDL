...
# Three targeted jobs exposed ordering changes in retained negative fixtures:
# the schema-6 checkout-integrity guard correctly rejects an inherited mutation
# before the older span or integration reviewer.  This successor changes only
# the exact audit programs needed to recognize those stronger rejections.
...
CONTRACT_SHA256 = "57c4cc16ceba39cd0af468e63a28fa7807a0ef331642ae63a65e1463bbf9006f"
