...
LOCAL_ENABLE_CHECKER_SHA256 = "ec275449dde4dd627b1d8abe86c995690668a8fe2f1f930e5b82a86e99d59a99"
...
def integration_review(root: Path):
    ...
    require(hashlib.sha256(normalized).hexdigest() == "c97f932d103a446464a2b0dff27dfc17f3676e18dff895033ffbf5ae59466ac1",
