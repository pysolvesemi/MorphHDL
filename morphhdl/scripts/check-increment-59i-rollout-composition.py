...
LOCAL_ENABLE_CHECKER_SHA256 = "67e00a976d556706689ca3e3d0b325595d21335a680ad5d6dc92b1ce646cd73e"
...
def integration_review(root: Path):
    ...
    require(hashlib.sha256(normalized).hexdigest() == "ecaa4d0f11713a8e868b719dcd1e04bab1b17c2bb2815d5a87b7ea159ebc4f4d",
