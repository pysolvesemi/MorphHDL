...
def source_scope(root: Path) -> None:
    ...
    native_revision = review.TARGET_PARENT if review is not None else "HEAD"
    ...
    manifest_source = target_source(root, review, manifest_path, (root / manifest_path).read_text())
