...
NATIVE_MANIFEST_SHA256 = '070d4b336c6035eb7f7c30a8d6c76cdb760a8cf16d5d4cd04f51b9a3f4cdc449'
CONTRACT = "morphhdl/contracts/increment-60g-publication-edits.json"
CONTRACT_SHA256 = "94cbc2283ea777271a2e41d0395223fadce74f10f4184eb5f4868821b8d28e66"
...
PRODUCTION = {
    ...
    "morphhdl/src/main/scala/spinal/core/internals/MorphHdlSignednessAnalysis.scala": "9011d8a9094d88d6a3d7893c7b64d8a6ae4b8c48ac357b00ee2a06ee8452c06f",
    "morphhdl/src/main/scala/spinal/core/internals/MorphHdlSignedDeclarationPolicy.scala": "3f7c8d8d5abfe4fb30ce03de6deb56e170d0d385151032b53661af36ef6d4ea9",
    "morphhdl/src/main/scala/spinal/core/internals/ExternalParameterizedNativeResize.scala": "eea086292b5986c91e2b0ddb13f4bd28d5c09ac9f2210175930cbd80fa63825b",
    "morphhdl/src/main/scala/spinal/core/internals/ExternalParameterizedVerilogNativeFallback.scala": "d5d9de2e4050378abbd509bd91f810520b485704a3d5806a39b8f50d0c074a13",
    "morphhdl/src/main/scala/spinal/core/internals/ParameterizedVerilogStructural.scala": "af71b38b078c20f41d1d29a21da6b16fb7afb8eeb03cdf445d3f55e7a718c8f1"
}
QUALIFICATION = {
    "morphhdl/src/test/scala/morphhdl/SignednessCompatibilityTests.scala": "f8ddd7c59bf44e5f76bc0e8a0e7af019bd5c10724f0fd9dd33127c4648e0ebff",
...
def source_scope(root: Path) -> None:
    ...
    changed = {p for p in git("diff", "--no-renames", "--name-only", BASE).splitlines()
               if "/src/main/" in "/" + p}
    require(changed == set(PRODUCTION), "60g production exceeds eight publication files and one scheduler lifecycle hook: " + str(sorted(changed)))
    ...
    oracle_only(root)
    print("60g eight-file publication policy, sealed fixture selection and exact native lifecycle hook PASS", flush=True)
