...
module RecursiveFillCleanupRepro #(
  ...
  wire       [17:0]   _zz__zz_selectedUpper;
  wire       [17:0]   _zz__zz_readFill;
  ...
  wire       [(FIFO_LOG_DEPTH + 2)-1:0]    _zz_readFill;

  assign _zz__zz_selectedUpper = {13'd0, upper};
  assign _zz__zz_readFill = {13'd0, lower};
  ...
  assign _zz_selectedUpper = ((fifo_capacity < _zz__zz_selectedUpper) ? fifo_capacity : morphhdl_resize);
  assign selectedUpper = _zz_selectedUpper;
  ...
  assign _zz_readFill = ((bypass || (fifo_capacity < _zz__zz_readFill)) ? zeroFill : lower);
  assign readFill = _zz_readFill;
